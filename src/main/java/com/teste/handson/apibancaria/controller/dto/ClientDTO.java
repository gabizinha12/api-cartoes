...
public class ClientDTO implements Serializable {
	...
	public ClientDTO(Long id, String email, String name, String numDocument, String birthDate, String zipCode, String address, String addressNumber, String addressComplement, String neighborhood, String cityAddress, String state, String profession, BigDecimal salary, Boolean isEmployee, Boolean has5Years, String enrollment, String admissionDate, JobRole role) {
		this.id = id;
		this.email = email;
		this.name = name;
		this.numDocument = numDocument;
